    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_name",
                    models.CharField(max_length=200, verbose_name="Nombre de empresa"),
                ),
                (
                    "trade_name",
                    models.CharField(
                ...
                (
                    "mobile",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="Móvil"
                    ),
                ),
                (
                    "fax",
                ...
                (
                    "country",
                    models.CharField(
                        default="Venezuela", max_length=100, verbose_name="País"
                    ),
                ),
                (
                    "payment_terms",
                    models.PositiveIntegerField(
                        default=30, verbose_name="Términos de pago (días)"
                    ),
                ),
                (
                    "credit_limit",
                ...
                (
                    "is_preferred",
                    models.BooleanField(
                        default=False, verbose_name="Proveedor preferido"
                    ),
                ),
                (
                    "rating",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extension",
                    models.CharField(
                        blank=True, max_length=10, null=True, verbose_name="Extensión"
                    ),
                ),
                (
                    "is_primary",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "supplier_sku",
                    models.CharField(max_length=100, verbose_name="SKU del proveedor"),
                ),
                (
                    "supplier_name",
                    models.CharField(
                        max_length=200, verbose_name="Nombre según proveedor"
                    ),
                ),
                (
                    "cost_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Precio de costo"
                    ),
                ),
                (
                    "minimum_quantity",
                    models.PositiveIntegerField(
                        default=1, verbose_name="Cantidad mínima"
                    ),
                ),
                (
                    "lead_time",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="Proveedor preferido para este producto",
                    ),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="Activo")),
                (
